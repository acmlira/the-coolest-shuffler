...
// DeckManager is an autogenerated mock type for the DeckManager type
type DeckManager struct {
	mock.Mock
}

// CreateNewDeck provides a mock function with given fields: _a0, shuffle, amount, codes, values, suits
func (_m *DeckManager) CreateNewDeck(_a0 context.Context, shuffle bool, amount int, codes []string, values []string, suits []string) model.Deck {
...
func (_m *DeckManager) DrawCard(_a0 context.Context, id uuid.UUID, count int) model.Draw {
...
func (_m *DeckManager) OpenDeck(_a0 context.Context, id uuid.UUID) model.Deck {
...
type mockConstructorTestingTNewDeckManager interface {
	mock.TestingT
	Cleanup(func())
}

// NewDeckManager creates a new instance of DeckManager. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewDeckManager(t mockConstructorTestingTNewDeckManager) *DeckManager {
	mock := &DeckManager{}
	mock.Mock.Test(t)
